...
import yashImg from "../../../public/yash.jpg";
import { Contact } from "@/config/socials";
import { featuredPortfolios } from "@/config/portfolio";
        ...
        <div className="container flex max-w-[64rem] flex-col items-center gap-4 text-center -mt-20">
          ...
          <div className="mt-4 max-w-[42rem] text-center">
            <p className="leading-normal text-muted-foreground text-sm sm:text-base">
              A Mern Stack Developer, Startup Founder, and Visionary Leader, turning bold ideas into powerful, scalable web solutions.
            </p>
          </div>
          ...
          <div className="flex flex-col mt-10 items-center justify-center sm:flex-row sm:space-x-4 gap-3">
            <AnimatedText delay={0.6}>
              <Link
                ...
                aria-label="View Yash Vekariya's Portfolio"
              >
                <Icons.portfolio className="w-4 h-4 mr-2" /> Portfolio
              </Link>
            </AnimatedText>
            <AnimatedText delay={0.8}>
              <Link
                ...
                aria-label="Contact Yash Vekariya"
              >
      ...
      >
        <div className="mx-auto flex max-w-[58rem] flex-col items-center space-y-4 text-center">
          ...
          <AnimatedText
            ...
            className="max-w-[85%] leading-normal text-muted-foreground sm:text-lg sm:leading-7"
          >
            {pagesConfig.company.description}
          </AnimatedText>
        </div>
